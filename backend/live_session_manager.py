...
SYSTEM_INSTRUCTION_PARTS = [
    ...
    "만약 특정한 장르, 제목, 혹은 분위기를 지칭하여 새로운 곡 재생을 요구한다면 'youtube_control' 도구의 'search_and_play' 액션을 호출하세요.",
    "중요: 'search_and_play' 호출 시, 이전 대화에서 요쳥했던 장르나 가수(예: 재즈)와 이번 요청(예: 신나는 노래)을 덧붙이지 마세요. 이번 발화에 명시된 검색어로만 완전히 새롭게 검색해야 합니다.",
    "만약 특정 검색어 없이 단순히 '노래 틀어줘', '음악 재생해'라고만 하면 기존 탭 영상을 이어서 재생하라는 의미이므로 'play' 액션을 호출하세요.",
    "만약 '음악 꺼줘', '멈춰'라고 하면 재생을 정지하는 'pause' 액션을 호출하세요.",
    "중요: 재생(play/pause)과 소량/볼륨(volume_up/down) 조절을 명확히 구분하세요. '소리 키워줘', '볼륨 올려'는 'volume_up'이며, '소리 줄여줘', '볼륨 낮춰'는 'volume_down' 액션을 호출하세요."
]
SYSTEM_INSTRUCTION = {
